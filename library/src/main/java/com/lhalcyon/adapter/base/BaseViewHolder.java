 ...
 */
package com.lhalcyon.adapter.base;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     *  Will set text color of a TextView
     *
     * @param context The context ref
     * @param viewId The view id.
     * @param textColorResId The text color resource id
     * @return
     */
    public BaseViewHolder setTextColorRes(Context context,int viewId,int textColorResId){
        TextView view = getView(viewId);
